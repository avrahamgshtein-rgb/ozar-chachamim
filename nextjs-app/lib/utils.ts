...
/**
 * The century a century-precision window starts in. CE and BCE count in
 * opposite directions: the window 1100..1200 is the 12th century, but
 * -1300..-1200 is the 13th century BCE, not the 14th.
 */
function centuryOf(birth: number): number {
  return birth < 0 ? Math.ceil(-birth / 100) : Math.floor(birth / 100) + 1
}
